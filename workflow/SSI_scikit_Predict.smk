...
rule all:
    input:
        expand('output/Vis_Pairplot/Predict/{list_l}.png',list_l=list_LOOCV),
        expand('output/Vis_Umap/Predict/{list_l}.png',list_l=list_LOOCV)
...
rule SSI_scikit_Predict_py:
    ...
    benchmark:
        'benchmarks/y_score/{list_l}.txt'
    container:
        "docker://yamaken37/ssi_sklearn_env:202212141249"
    resources:
        mem_gb=200
    log:
        'logs/y_score/{list_l}.log'
    shell:
...
rule SSI_Vis_Pairplot:
    input:
        ...
        'output/y_predict/{list_l}.csv'
    output:
        'output/Vis_Pairplot/Predict/{list_l}.png',
        'output/Vis_Umap/Predict/{list_l}.png'
    benchmark:
        'benchmarks/Vis_Pairplot/Predict/{list_l}.txt'
    container:
        'docker://yamaken37/ssi_vis_pairplot:20230106'
    resources:
        mem_gb=200
    log:
        'logs/Vis_Pairplot/Predict/{list_l}.log'
    shell:
