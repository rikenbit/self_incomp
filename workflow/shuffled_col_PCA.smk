...
rule all:
    input:
        expand('output/LOOCV_rf/shuffled_col_PCA_{DIM}.csv', DIM=dimention,)
...
rule u_models:
    input:
        'output/inputTensors.RData'
    output:
        'output/X_Tensor/shuffled_col_PCA_{DIM}.RData',
        'output/X_Tensor/shuffled_col_PCA_{DIM}.csv'
    benchmark:
    ...
    resources:
        mem_gb=200
    log:
        'logs/X_Tensor/shuffled_col_PCA_{DIM}.log'
    shell:
        'src/shuffled_col_PCA.sh {input} {output} {wildcards.DIM}'
...
rule SSI_scikit_rf:
    input:
        ...
        'output/SSI/y_r.csv'
    output:
        'output/LOOCV_rf/shuffled_col_PCA_{DIM}.csv'
    benchmark:
        'benchmarks/LOOCV_rf/shuffled_col_PCA_{DIM}.txt'
    container:
        "docker://yamaken37/ssi_sklearn_env:202212141249"
    resources:
        mem_gb=200
    log:
        'logs/LOOCV_rf/shuffled_col_PCA_{DIM}.log'
    shell:
