...
# args_input_pattern <- c("MODELS_Model-1-A1_r1_20_r2_100_r3_5_r1L_xx_r1R_xx_r2L_xx_r2R_xx_r3L_xx_r3R_xx_")
...
input_path_list <- c()
for(i in cv_sort){
    eval(parse(text=paste0("path <- c('",args_input_dir,"/",args_input_pattern,"row_",i,".csv')")))
